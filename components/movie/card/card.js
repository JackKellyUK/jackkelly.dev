        ...
        <div className="h-full rounded-md overflow-hidden bg-gray-700">
          ...
          >
              <div className="relative">
                ...
                <button onClick={e => addToWatchList(e, data)} className={"absolute bottom-1.5 right-1.5 w-6 p-1 rounded-full border-white border-2" + (inWatchList ? " text-amber-400 border-amber-400" : "")}><FontAwesomeIcon icon={faStar} /></button>
              </div>
